...
/// <summary>
/// Main game loop architecture, commented context is provided for better understanding the purpose of this class; Комменты на русском или так понятно? 
/// </summary>
public class Game : MonoBehaviour   //Class containing main loop
{
	...
	private void Awake()
	{
		...
		human.AwakeManual(_teams[0], "Òîâàðèù", _factions[0]);
